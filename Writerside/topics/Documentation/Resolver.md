...
The Resolver page offers a simple interface resolve did:prism and did:indy based DIDs to their underlying DID-Documents. The page is available at [https://analytics.blocktrust.io/resolver](https://analytics.blocktrust.io/resolver).
In the background it quering the internal Analytics-Platform for the requested DID its metadata and references for prior versions.
